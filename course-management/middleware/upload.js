...
// Sử dụng memoryStorage sẽ giúp chúng ta thao tác với các tập tin trước khi lưu vào bộ nhớ hoặc database
...
/* 
```
phương thức để chỉ đinh cho phép upload 1 hay nhiều file
